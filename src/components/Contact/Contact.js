...
const sendEmail = (e) => {
  ...
  const subject = encodeURIComponent("New Website Inquiry - AP Frames");

  const body = encodeURIComponent(`NEW WEBSITE INQUIRY
...
${message}`);
  ...
  const email1 = "naikararyan@gmail.com";
  const email2 = "naikarxie@gmail.com";

  // Use mailto: with comma-separated emails for multiple recipients
  window.location.href = `mailto:${email1},${email2}?subject=${subject}&body=${body}`;
